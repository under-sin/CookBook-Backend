...
public class Version0000002 : VersionBase
{
    public override void Up()
    {
        CreateTable("Recipes")
            ...
            .WithColumn("UserId").AsInt32().NotNullable().ForeignKey("FK_Recipe_User_Id", "Users", "Id");

        CreateTable("Ingredients")
            .WithColumn("Item").AsString().NotNullable()
            .WithColumn("RecipeId").AsInt32().NotNullable().ForeignKey("FK_Ingredient_RecipeId", "Recipes", "Id")
        ...
        CreateTable("Instructions")
            ...
            .WithColumn("RecipeId").AsInt32().NotNullable().ForeignKey("FK_Instruction_RecipeId", "Recipes", "Id")
            .OnDelete(Rule.Cascade); 
        
        CreateTable("DishTypes")
            .WithColumn("Type").AsInt32().NotNullable()
            .WithColumn("RecipeId").AsInt32().NotNullable().ForeignKey("FK_DishType_RecipeId", "Recipes", "Id")
            .OnDelete(Rule.Cascade); 
    }
}